...
@app.post("/workout") # create a new workout, a list of exercises performed a certain amount of reps etc
...
@app.get("/workouts", response_model=List[WorkoutWithID]) # a list of all workouts
def get_workouts():
    return workouts
